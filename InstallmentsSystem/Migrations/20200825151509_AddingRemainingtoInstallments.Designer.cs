...
namespace InstallmentsSystem.Migrations
{
    ...
    [Migration("20200825151509_AddingRemainingtoInstallments")]
    partial class AddingRemainingtoInstallments
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("InstallmentsSystem.Entities.Models.Client", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
            ...
            modelBuilder.Entity("InstallmentsSystem.Entities.Models.Role", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER");
            ...
            modelBuilder.Entity("InstallmentsSystem.Entities.Models.User", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER");
            ...
            modelBuilder.Entity("InstallmentsSystem.Entities.Models.UserRole", b =>
                {
                    b.HasOne("InstallmentsSystem.Entities.Models.Role", null)
                        .WithMany()
                        .HasForeignKey("RoleId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("InstallmentsSystem.Entities.Models.Role", "Role")
                        .WithMany("User")
                        .HasForeignKey("RoleId1");

                    b.HasOne("InstallmentsSystem.Entities.Models.User", null)
                        .WithMany()
                        .HasForeignKey("UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("InstallmentsSystem.Entities.Models.User", "User")
                        .WithMany("Roles")
